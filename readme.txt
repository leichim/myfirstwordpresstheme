...
|Theme Resources|
The theme is based on the twentyten and twentytenfive them from smashingmagazine.com,
but is a complete make-over. It thankfully uses scripts and resources from Selectivizr, HTML5shiv, tutsplus.com, webdesignerwall.com,
tuttoaster.com, Comicpress, Matt Brett and others. 
...
* Recommended size for images used as feature image, which will then also be used for creating thumbnails, is 590*236, 
